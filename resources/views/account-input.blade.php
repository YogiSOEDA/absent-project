        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Pengaturan Akun /</span> Input Akun Baru</h4>

              <div class="row">
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    <li class="nav-item">
                      <a class="nav-link active" href="javascript:void(0);"><i class="bx bx-user me-1"></i> Input Akun Baru</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="/kelola-akun"
                        ><i class="bx bx-bell me-1"></i> Kelola Data Akun</a
                      >
                    </li>
                   
                  </ul>
                  <div class="card mb-4">
                    <h5 class="card-header">Input Akun Baru</h5>
                      ...
                      <form id="formAccountSettings" method="POST" onsubmit="return false">
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input class="form-control" type="text" name="namaLengkap" id="namaLengkap" value="" />
                          </div>
