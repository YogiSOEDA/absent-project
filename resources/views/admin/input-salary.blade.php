                ...
                <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                    <div class="app-brand demo">
                        <a href="index.html" class="app-brand-link">
                            ...
                            <span class="app-brand-text demo menu-text fw-bolder ms-2">LPD TEGAK</span>
                        </a>
                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Penggajian /</span>
                                Input Gaji Karyawan</h4>

                            <div class="row">
                                <div class="col-md-12">

                                    <div class="card mb-4">
                                        <h5 class="card-header">Input Gaji Karyawan</h5>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form id="formAccountSettings" method="POST" onsubmit="return false">
                                                <div class="row">
                                                    ...
                                                    <div class="mb-3 col-md-6">
                                                        <label for="tunjanganJabatan" class="form-label">Tunjangan
                                                            Jabatan</label>
                                                        <input class="form-control" type="text" id="tunjanganJabatan"
                                                            name="tunjanganJabatan" value="" placeholder="" />
                                                    </div>
                                                    ...
                                                    <div class="mb-3 col-md-6">
                                                        ...
                                                        <div class="input-group input-group-merge">
                                                            <input type="text" id="gajiPokok" name="gajiPokok"
                                                                class="form-control" placeholder="" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-3 col-md-6">
                                                        <label class="form-label" for="beras">Tunjangan
                                                            Beras</label>
                                                        <div class="input-group input-group-merge">
                                                            <input type="text" id="beras" name="beras"
                                                                class="form-control" placeholder="" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-3 col-md-6">
                                                        <label class="form-label" for="absen">Potongan Absen</label>
                                                        <div class="input-group input-group-merge">
                                                            <input type="text" id="absen" name="absen"
                                                                class="form-control" placeholder="" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-3 col-md-6">
                                                        <label class="form-label" for="total">Total Gaji</label>
                                                        <div class="input-group input-group-merge">
