                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4">
                            <span class="text-muted fw-light">Data Karyawan /</span> Kelola Data Karyawan
                        </h4>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <ul class="nav nav-pills flex-column flex-md-row mb-3">
                                    <li class="nav-item">
                                        <a class="nav-link" href="/input-karyawan"><i
                                                class="bx bx-user me-1"></i>
                                            Input Data Karyawan</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link active" href="javascript:void(0);"><i
                                                class="bx bx-bell me-1"></i>
                                            Kelola Data Karyawan</a>
                                    </li>
                                </ul>
                                ...
                                <div class="card">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="mt-2">
                                                            ...
                                                            <button type="submit" class="btn btn-secondary">Buat Data
                                                                Face</button>
                                    ...
                                    <div class="card">
                                        <nav class="card-body" aria-label="Page navigation">
