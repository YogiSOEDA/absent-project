            ...
            <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Absensi /</span>
                                  </h4>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form id="formAccountSettings" method="POST" onsubmit="return false">
                                                <div class="row">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="id" class="form-label">Id Karyawan
                                                            </label>
                                             ...
                                             <br>
                                             <a href="/recognition" class="menu-link">
                                                <div class="d-grid gap-2 col-12 ">
                                                        <button class="btn btn-primary btn-lg" type="button">Scan Wajah</button>
                                                </div>
                                            </a>
                                        </div>
