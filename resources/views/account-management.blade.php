        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4">
              <span class="text-muted fw-light">Pengaturan Akun /</span> Kelola Data Akun
            </h4>
            ...
            <div class="row">
              <div class="col-md-12">
                <ul class="nav nav-pills flex-column flex-md-row mb-3">
                  <li class="nav-item">
                    <a class="nav-link" href="/input-akun"><i class="bx bx-user me-1"></i>
                      Input Akun Baru</a>
                  </li>
                  <li class="nav-item">
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <div class="mt-2">
                              <button type="edit" class="btn btn-primary me-2">Edit</button>
                              <button type="delete" class="btn btn-outline-secondary">Hapus</button>
                            </div>
                          </td>
                        </tr>
                      </tbody>
